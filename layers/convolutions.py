...
class HarmonicConv2d(HarmonicBlock):
    def __init__(self, *args, **kwargs):
        super(HarmonicConv2d, self).__init__(output_channels=1,
                                             *args, **kwargs)
        self.conv = None
        self.bn = None
        self.dropout = None
...
class HarmonicConvTranspose2d(HarmonicBlock):
    def __init__(self, _output_channels=3, *args, **kwargs):
        super(HarmonicConvTranspose2d,
              self).__init__(input_channels=_output_channels,
                             output_channels=1,
                             *args, **kwargs)
        self.conv = None
        self.bnorm = None
...
class HadamardConv2d(HadamardBlock):
    def __init__(self, *args, **kwargs):
        super(HadamardConv2d, self).__init__(output_channels=1,
                                             *args, **kwargs)
        self.conv = None
        self.bnorm = None
        self.shortcut = None
...
class SlantConv2d(SlantBlock):
    def __init__(self, *args, **kwargs):
        super(SlantConv2d, self).__init__(output_channels=1,
                                          *args, **kwargs)
        self.conv = None
        self.bnorm = None
        self.shortcut = None
